...
#temporary################################################################
        ...
        ##################
            ...
            folder= '/net/krypton/data0/project/meddle/gula/ROMS/Simulations/GS/'
        ...
        ##################
            ...
            if os.getenv('HOSTNAME') is None:
                folder= '/net/krypton/data0/project/meddle/lecorre/POLGYR/AVG'
                self.his=folder + '/polgyr_his.'
                self.grd='/net/krypton/data0/project/meddle/lhoupert/polgyr_grd.nc'
            else:
        ...
        ##################
            ...
            try:
                ...
                folder= '/net/krypton/data0/project/meddle/gula/ROMS/Simulations/SISMO/'
