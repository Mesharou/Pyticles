...
# endif
     ...
     &                                                            )))
        ...
        if (i.eq.182 .and. j.eq.54 .and. k.eq.0) then
         write(*,*) 'dRx(i,j)',dRx(i,j),dRx(i-1,j)
         write(*,*) 'dZx(i,j)',dZx(i,j),dZx(i-1,j)
         write(*,*) 'rho(i,j,k)',rho(i,j,k),rho(i-1,j,k
         write(*,*) 'P(i,j,k)',P(i,j,k),P(i-1,j,k)
        endif
