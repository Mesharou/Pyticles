...
#   Main 
###################################################################################
    def __init__(self,simulname=None,time=None, floattype=np.float, light = False, light_bulk = False, touchfile=True, output =True, **kwargs):
...
#temporary################################################################
       ...
       ##################
            ...
            if 'mean' in simul:
                ...
                self.dtfile=3600
                self.tend=100000
            elif 'M' in simul or 'UV' in simul or 'uv' in simul:
                ...
                if 'gigatl3_1h_tides' in simul:
                    self.his = '/net/omega/local/tmp/2/gula/GIGATL3/uvbot/gigatl3_1h_tides_uvbot.'
                    self.dtfile=3*3600
                    self.tfile=40
                elif 'gigatl3_1h' in simul:
                    if time < 2330:
                        self.his = '/net/omega/local/tmp/2/gula/GIGATL3/uvbot/gigatl3_1h_UP5_uvbot.'
                    else:
                        self.his = '/net/omega/local/tmp/2/gula/GIGATL3/uvbot/gigatl3_1h_uvbot.'
                    self.dtfile=12*3600
                    self.tfile=10
       ...
       ##################        
        ...
        ##################
            ...
            if 'avg' in simul:
                if 'vrt' in simul:
                    self.his = folder + '/rrex100_diags_vrt_avg.'
                elif 'ek' in simul:
                    self.his = folder +  '/rrex100_diags_ek_avg.'
                elif 'uv' in simul:
                    self.his = folder + '/rrex100_diaM_avg.'
                elif 'ts' in simul:
                    self.his = folder + '/rrex100_dia_avg.'
                elif 'pv' in simul:
                    self.his = folder + '/rrex100_diags_pv_avg.'
                else:
                    self.his = folder + '/rrex100_avg.'
            else:
                if 'vrt' in simul:
                    self.his = folder +  '/rrex100_diags_vrt.'
                elif 'ek' in simul:
                    self.his = folder + '/rrex100_diags_ek.'
                elif 'uv' in simul:
                    self.his = folder +  '/rrex100_diaM.'
                elif 'ts' in simul:
                    self.his = folder +  '/rrex100_dia.'
                elif 'pv' in simul:
                    self.his = folder +  '/rrex100_diags_pv.'
                else:
                    self.his = folder +  '/rrex100_his.'
